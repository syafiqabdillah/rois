...
class SupervisorHeader extends Component {
      ...
      <React.Fragment>
        ...
        <Nav className="d-md-down-none" navbar>
          <NavItem className="px-3">
            <Link to="/employees" className="nav-link" >Onboarding Employee</Link>
          </NavItem>
...
SupervisorHeader.propTypes = propTypes;
SupervisorHeader.defaultProps = defaultProps;
