...
import { Button, Card, CardBody, CardHeader, Col, Row, Table, CardImg, CardTitle, CardText, CardDeck, CardGroup,
  CardSubtitle, CardColumns } from 'reactstrap';
...
class VacanciesPelamar extends Component {
  ...
  handleOnClick(id) {
    let id_lowongan = id;
    //console.log('akan apply ' + id_lowongan);
    //redirect ke /apply/{id_lowongan}
