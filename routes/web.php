...
$router->post('po/send-mail-reject', ['middleware' => 'cors', 'uses' => 'LamaranController@sendMailReject']);
$router->post('po/send-mail-hire', ['middleware' => 'cors', 'uses' => 'LamaranController@sendMailHire']);

/**
 * UC - 04 : PO Membuat Remote Test
 * Author : M Raffi A
 */
...
/**
 * UC - 06 : PO Membuat Appointment Interview
 * Author : Fairuz Y
 */
...
/**
 * UC - 08 : PO Melihat Laporan Ringkasan Hasil Penerimaan
...
/**
 * UC - 13 : System Admin Mengelola Data Akun Karyawan
 * Author : Syafiq Abdillah Umarghanis
 */
